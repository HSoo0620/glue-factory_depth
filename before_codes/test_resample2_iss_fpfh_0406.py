...
사용법:
    python test_resample2_iss_fpfh_0406.py --checkpoint outputs/training/0406_resample2_iss_fpfh_xyz_lg/checkpoint_best.tar --indices 0 10 50 90
    python test_resample2_iss_fpfh_0406.py --experiment 0406_resample2_iss_fpfh_xyz_lg --split test --num_samples 10
"""
...
def main():
    ...
    parser.add_argument("--experiment", type=str, default="0406_resample2_iss_fpfh_xyz_lg")
