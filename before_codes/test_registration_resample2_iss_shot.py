...
사용법:
    python test_registration_resample2_iss_shot.py --experiment 0407_resample2_iss_shot352_lg --indices 0 10 50 90
    python test_registration_resample2_iss_shot.py --checkpoint outputs/training/0407_resample2_iss_shot352_lg/checkpoint_best.tar --conf_th 0.1 --inlier_th 5.0
"""
...
def visualize_registration(
    ...
    H, W = d0_vis.shape
    # input 이미지 크기가 master와 다를 경우 resize
    ...
    fig.suptitle(
        f"[Resample2 ISS+SHOT+LG]  Matches: {n_matches}  |  3D: {n_3d}  |  "
...
def main():
    parser = argparse.ArgumentParser(description="학습된 ISS+SHOT+LG 기반 resample_2 3D Registration")
