"""v1 (2026-04-15) ISS+FPFH+LG Registration 평가 — Transform 기반 양방향 RMSE.
...
사용법:
    python experiments/v1_20260415/eval/rmse_fpfh.py --experiment iss_fpfh_v1_20260415
    python experiments/v1_20260415/eval/rmse_fpfh.py --experiment iss_fpfh_v1_20260415 --indices 0 10 50 90
    python experiments/v1_20260415/eval/rmse_fpfh.py \
...
DEFAULT_OUTPUT_DIR = "results/iss_fpfh_v1_20260415_eval"
...
def evaluate_pair(model, dataset, idx, device, args):
    ...
    batch_fwd = v1_iss_fpfh_collate_fn([sample])
...
def main():
    parser = argparse.ArgumentParser(
        description="v1_20260415 ISS+FPFH+LG Registration Eval (Transform RMSE, mm)"
    )
