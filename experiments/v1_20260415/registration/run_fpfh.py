"""v1 (2026-04-15) ISS+FPFH+LG 기반 3D Registration 테스트.
...
파이프라인:
    1. 학습된 ISS+FPFH+LG로 zero-pad depth image pair 매칭
    2. 매칭된 keypoint를 mm 좌표 (X, Y, Z)로 변환
    3. RANSAC + SVD로 rigid transformation (R, t) 추정
    4. 변환 적용 후 3-panel 정합 시각화 (Master / Input / Overlay)

사용법:
    python experiments/v1_20260415/registration/run_fpfh.py --experiment iss_fpfh_v1_20260415
    python experiments/v1_20260415/registration/run_fpfh.py --experiment iss_fpfh_v1_20260415 --indices 0 10 50
    python experiments/v1_20260415/registration/run_fpfh.py --n_pairs 20 --inlier_th 5.0
"""
...
DEFAULT_OUTPUT_DIR = "results/iss_fpfh_v1_20260415_registration"
...
def visualize_registration(
    ...
    fig.suptitle(
        f"[v1 ISS+FPFH+LG]  Matches: {n_matches}  |  3D: {n_3d}  |  "
...
def main():
    parser = argparse.ArgumentParser(
        description="v1_20260415 ISS+FPFH+LG 기반 3D Registration"
    )
