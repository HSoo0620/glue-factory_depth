...
사용법:
    python eval_registration_iss_fpfh.py --experiment 0406_resample2_iss_fpfh_xyz_lg --indices 0 10 50 90
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="ISS+FPFH+LG Registration Eval (Transform RMSE)")
