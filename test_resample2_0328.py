"""
학습된 SP+LG 모델로 resample_2 데이터 매칭 테스트.

사용법:
    python test_resample2_0328.py --checkpoint outputs/training/0328_resample2_sp_lg/checkpoint_best.tar --indices 0 10 50 90
    python test_resample2_0328.py --experiment 0328_resample2_sp_lg --split test --num_samples 10
"""
...
def main():
    parser = argparse.ArgumentParser(description="학습된 SP+LG로 resample_2 매칭 테스트")
