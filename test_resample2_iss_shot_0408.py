"""
학습된 ISS(det)+SHOT(desc)+LG 모델로 resample_2 데이터 매칭 테스트.

사용법:
    python test_resample2_iss_shot_0408.py --indices 0 10 50 90
"""
...
def main():
    parser = argparse.ArgumentParser(description="학습된 ISS+SHOT+LG로 resample_2 매칭 테스트")
