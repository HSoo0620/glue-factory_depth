...
사용법:
    python test_registration_resample2_iss_fpfh_0406_rmse.py --experiment 0402_resample2_iss_fpfh_xyz_lg --indices 0 10 50 90
"""
...
def visualize_registration(
    ...
    fig.suptitle(
        f"[ISS+FPFH+LG | O3D RANSAC]  Matches: {n_matches}  |  3D: {n_3d}  |  "
...
def main():
    parser = argparse.ArgumentParser(
        description="ISS+FPFH+LG 3D Registration (O3D RANSAC + GT RMSE)"
    )
