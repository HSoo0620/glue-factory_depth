"""
학습된 SP+LG 모델로 resample 데이터 매칭 테스트.

사용법:
    python test_resample.py --checkpoint outputs/training/resample_sp_lg/checkpoint_best.tar --indices 0 10 50 90
"""
...
def main():
    parser = argparse.ArgumentParser(description="학습된 SP+LG로 resample 매칭 테스트")
