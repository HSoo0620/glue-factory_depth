...
from .datasets.mitsubishi_resample_hybrid_dataset import MitsubishiResampleHybridDataset
from .datasets.mitsubishi_resample_hybrid_dataset import resample_hybrid_collate_fn
...
def training(rank, conf, output_dir, args):
    ...
    fpfh_radius = conf.data.get("fpfh_radius", 0.5)
    ...
    val_dataset = MitsubishiResampleHybridDataset(
    ...
    train_loader = DataLoader(
        ...
        collate_fn=resample_hybrid_collate_fn,
    )
