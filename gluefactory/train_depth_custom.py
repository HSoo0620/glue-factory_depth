...
from .datasets.mitsubishi_depth_dataset import MitsubishiDepthDataset
from .datasets.mitsubishi_depth_dataset import mitsubishi_collate_fn
...
def training(rank, conf, output_dir, args):
    ...
    dataset = MitsubishiDepthDataset(split="train")

    val_dataset = MitsubishiDepthDataset(split="val")
