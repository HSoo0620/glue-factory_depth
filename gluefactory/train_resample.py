...
from .datasets.mitsubishi_resample_dataset import MitsubishiResampleDataset
from .datasets.mitsubishi_resample_dataset import resample_collate_fn
...
def training(rank, conf, output_dir, args):
    ...
    dataset = MitsubishiResampleDataset(split="train", image_size=image_size)
    val_dataset = MitsubishiResampleDataset(split="val", image_size=image_size)
    ...
    train_loader = DataLoader(
        ...
        collate_fn=resample_collate_fn,
    )
