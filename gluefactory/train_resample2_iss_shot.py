"""
Resample_2 ISS+SHOT352 데이터용 학습 스크립트.
ISS(detector) + C++ SHOT352(descriptor) + LightGlue.
"""
...
def training(rank, conf, output_dir, args):
    ...
    dataset     = MitsubishiResample2ISSSHOTDataset(split="train", cache_dir=cache_dir, image_size=image_size)
    val_dataset = MitsubishiResample2ISSSHOTDataset(split="val",   cache_dir=cache_dir, image_size=image_size)
