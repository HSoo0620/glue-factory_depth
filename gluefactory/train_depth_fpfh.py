...
from .datasets.mitsubishi_depth_fpfh_dataset import MitsubishiDepthFPFHDataset as MitsubishiDepthDataset
from .datasets.mitsubishi_depth_fpfh_dataset import mitsubishi_fpfh_collate_fn as mitsubishi_collate_fn
...
def training(rank, conf, output_dir, args):
    ...
    dataset = MitsubishiDepthDataset(split="train", fpfh_radius=fpfh_radius)

    val_dataset = MitsubishiDepthDataset(split="val", fpfh_radius=fpfh_radius)
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,
        num_workers=8,
        collate_fn=mitsubishi_collate_fn,
    )
